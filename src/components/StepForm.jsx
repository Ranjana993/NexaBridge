...
// Typewriter component with cursor and cleanup
const Typewriter = ({ text, speed = 30, delay = 0, loop = false }) => {
      ...
      const timeout = setTimeout(() => {
        if (!isDeleting) {
          ...
          if (currentIndex < text.length) {
            ...
            // Start deleting after a pause if loop is true
  ...
  }, [currentIndex, text, speed, delay, isDeleting, displayedText, loop]);
              ...
              <>
                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    >
                      <Typewriter text={stepTexts[1]} speed={30} delay={300} loop={true} />
                    </motion.p>
                ...
                {step === 2 && (
                  ...
                  >
                    ...
                    <motion.p
                      ...
                      className="text-center text-gray-600 mb-4 min-h-[3rem]"
                    >
                      <Typewriter text={stepTexts[2]} speed={30} delay={300} loop={true} />
                    </motion.p>
                ...
                {step === 3 && (
                  ...
                  >
                    ...
                    <p
                      className="text-lg mb-2 mt-8 text-center flex items-center gap-4 pb-4 justify-center"
                    >
                      <span className='bg-[#0A5216] p-1 rounded-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M20 6 9 17l-5-5" />
                    ...
                    <motion.p
                      ...
                      className="text-center text-gray-600 mb-4 min-h-[3rem]"
                    >
                      <Typewriter text={stepTexts[3]} speed={30} delay={300} loop={true} />
                    </motion.p>
                ...
                {step === 4 && (
                  ...
                  >
                    ...
                    <motion.p
                      ...
                      className="text-center text-gray-600 mb-4 min-h-[3rem]"
                    >
                      <Typewriter text={stepTexts[4]} speed={30} delay={300} loop={true} />
                    </motion.p>
